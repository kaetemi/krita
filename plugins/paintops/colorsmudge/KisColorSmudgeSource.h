...
{
    explicit KisColorSmudgeSourcePaintDevice(KisOverlayPaintDeviceWrapper &overlayDevice, int overlayIndex = 0);
...
{
    explicit KisColorSmudgeSourceImage(KisImageSP image,
